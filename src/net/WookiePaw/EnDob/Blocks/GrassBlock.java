...
public class GrassBlock extends Block implements GenericBlockManager{
    ...
    private BlockSkin skin = new BlockSkin(new BlockSkin_TextureLocation[] { new BlockSkin_TextureLocation(0, 0), new BlockSkin_TextureLocation(1, 0), new BlockSkin_TextureLocation(2, 0) }, isWalkThroughable)
    {
