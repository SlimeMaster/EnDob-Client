...
public class World {
    ...
    public World(String name){
        this.blockTerrain = new BlockTerrainControl(CubesTestAssets.getSettings(EnDob.game), new Vector3Int(5, 5, 5));
        this.worldName = name;
    }
    ...
    public void setBlock(Location l, Class<? extends Block> b){
        this.blockTerrain.setBlock(l.toVector3Int(), b);
    }
    
    public BlockTerrainControl getTerrainControl(){
        return this.blockTerrain;
    }
    
        public void setBlock(Vector3Int l, Class<? extends Block> b){
        this.blockTerrain.setBlock(l, b);
    }
}
